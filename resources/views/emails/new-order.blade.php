                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tr style="border-collapse:collapse">
                                            <td align="center"
                                                ...
                                                @if($order)
                                                    {!! \App\Helpers\BasketService::getOrderDescription($order) !!}
                                                @endif
                                                @if(isset($extra) && $extra)
                                                    <hr>
                                                    {!! \App\Helpers\BasketService::getPaymentExtraDescription($extra) !!}
                                                    @endif
                                                    </p></td>
                                        </tr>
                                        <tr style="border-collapse:collapse">
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%"
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="left" class="es-m-txt-l"
                                                    style="padding:0;Margin:0;padding-top:10px"><h3
                                                        ...
                                                        <strong>{{ $orderItem['product']->productName }}</strong></h3></td>
                                            </tr>
                                            <tr style="border-collapse:collapse">
                                                <td align="left" class="es-m-txt-l"
                                                    style="padding:0;Margin:0;padding-top:10px"><h3
                                                        style="Margin:0;line-height:23px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:19px;font-style:normal;font-weight:normal;color:#16c0ec">
                                                        <strong>{{ $orderItem['detail']->amount }}<span
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="left" class="es-m-txt-l"
                                                    style="padding:0;Margin:0;padding-top:10px"><h3
                                                        style="Margin:0;line-height:23px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:19px;font-style:normal;font-weight:normal;color:#16c0ec">
                                                        <strong><span style="color:#000000">Tutar:</span>&nbsp;{{ \App\Http\Helpers\HelperController::formatted_price($orderItem['detail']->price) }}<span></strong>
                                                    </h3></td>
                                            </tr>
                                        </table>
                                    </td>

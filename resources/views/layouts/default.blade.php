...
<head>
    ...
    <link id="favicon" rel="shortcut icon" type="image/png" href="/favicon.png?v=1">
    @if(isset($ogs))
        @foreach($ogs as $og)
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.1/jquery.min.js?_v={{ env('ASSETS_VER') }}"></script>
    <script src="https://code.jquery.com/ui/1.13.2/jquery-ui.js?_v={{ env('ASSETS_VER') }}"></script>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.css?_v={{ env('ASSETS_VER') }}" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.min.css?_v={{ env('ASSETS_VER') }}">
...
{{--    <script src="{{ url('assets/js/contact-us.js') }}?_v={{ env('ASSETS_VER') }}"></script>--}}
    ...
    <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js?_v={{ env('ASSETS_VER') }}"></script>
    <!-- Google Tag Manager -->
    ...
    <style>
        ...
        body.sticky-header #app-content {
            margin-top: 160px;
        }
...
<body class="@yield('body_class') sticky-header">

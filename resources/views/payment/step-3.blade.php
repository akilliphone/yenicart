...
{{--                <button class="tabSpec" onclick="openSpec(event, 'newCard')">Kayıtlı Kartlarım</button>--}}
                ...
                <button class="tabSpec" onclick="openSpec(event, 'havale')">Havale ile Ödeme</button>
                <button class="tabSpec" onclick="openSpec(event, 'taksit')">Taksitli Ödeme</button>
                ...
                <div class="shopping-wrapper">
                    <div class="form-wrapper">
                        @if($iyzico_form)
                            ...
                            {!! $iyzico_form !!}
                        @else
{{--                            <div id="newCard" class="tabDetails" style="display: block;">--}}
...
<g id="Front">
    <line class="st0" x1="35.3" y1="10.4" x2="36.7" y2="11"></line>
                          ...
                          C707.1,246.4,704.4,249.1,701.1,249.1z"></path>
                            ...
                            @if($iyzico_link)
                                <div class="tabDetails" id="taksit" style="display: none;margin-top: 75px;">
                                    <div class="creditcard-text">
                                        <div class="custom_radio">
                            ...
                            @endif
                        <div class="tabDetails"  id="havale" style="display: none;">
                            <div class="pay-transfer">
                                <div class="creditcard-text">
                                    ...
                                    {!! \BasketService::getPaymentDescription(5) !!}
                                </div>
                                <div class="pay-logo">
